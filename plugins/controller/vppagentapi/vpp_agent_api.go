...
// The vppagentapi provides routines to create objects like interfaces, BDs,
...
// ConstructL2BD returns an KeyValueEntryType
func ConstructL2BD(vppAgent string,
	bdName string,
	ifaces []*l2.BridgeDomains_BridgeDomain_Interfaces,
	bdParms *controller.BDParms) *KeyValueEntryType {
...
// AppendInterfacesToL2BD returns an KeyValueEntryType
func AppendInterfacesToL2BD(vppAgent string,
	l2bd *l2.BridgeDomains_BridgeDomain,
	ifaces []*l2.BridgeDomains_BridgeDomain_Interfaces) *KeyValueEntryType {
...
// ConstructEthernetInterface returns an KeyValueEntryType
func ConstructEthernetInterface(vppAgent string,
	...
	mtu uint32,
	adminStatus string,
	rxMode string) *KeyValueEntryType {
...
// ConstructLoopbackInterface returns an KeyValueEntryType
...
// ConstructMemInterface returns an KeyValueEntryType
func ConstructMemInterface(vppAgent string,
	...
	masterVppAgent string) *KeyValueEntryType {
...
// ConstructVxlanInterface returns an KeyValueEntryType
func ConstructVxlanInterface(vppAgent string,
	ifname string,
	vni uint32,
	ep1IPAddress string,
	ep2IPAddress string) *KeyValueEntryType {
...
// constructUniDirXConnect creates a unit directional entry returns an KeyValueEntryType
func constructUniDirXConnect(vppAgent, if1, if2 string) *KeyValueEntryType {
...
// ConstructXConnect creates a bidir xconn returns an []*KeyValueEntryType
func ConstructXConnect(vppAgent, if1, if2 string) []*KeyValueEntryType {

	kvVPP1 := constructUniDirXConnect(vppAgent, if1, if2)
	kvVPP2 := constructUniDirXConnect(vppAgent, if2, if1)
	return []*KeyValueEntryType{kvVPP1, kvVPP2}
}

// ConstructTapInterface returns an KeyValueEntryType
func ConstructTapInterface(vppAgent string,
	...
	adminStatus string,
	rxMode string,
	hostIfName string) *KeyValueEntryType {
...
// ConstructAFPacketInterface returns an KeyValueEntryType
...
// ConstructVEthInterface returns an KeyValueEntryType
func ConstructVEthInterface(vppAgent string,
	...
	hostIfName string,
	peerIfName string,
	vnfName string) *KeyValueEntryType {
...
// ConstructStaticRoute returns an KeyValueEntryType
func ConstructStaticRoute(vppAgent string, l3sr *controller.L3VRFRoute) *KeyValueEntryType {
